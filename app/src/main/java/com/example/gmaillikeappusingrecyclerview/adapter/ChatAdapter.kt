...
import com.example.gmaillikeappusingrecyclerview.databinding.ReceiverViewBinding
import com.example.gmaillikeappusingrecyclerview.databinding.SenderViewBinding
...
class ChatAdapter(private val context: Context, private val chats: ArrayList<Chat>) :
    ...
    inner class SenderViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        private val txtSender: TextView = bindingSender.senderTxt
    ...
    inner class ReceiverViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        private val txtReceiver: TextView = bindingReceiver.senderTxt
        fun bind(position: Int) {
